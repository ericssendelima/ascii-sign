...
{
  /// <summary>
  /// Represents a character dictionary for the "Shaded" font style, mapping characters to their corresponding ASCII art signatures.
  /// </summary>
  internal class Shaded : ICharacterDictionary
  {
    ...
    internal static readonly Shaded Instance = new();
